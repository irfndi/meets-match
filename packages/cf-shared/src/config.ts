...
export const AppConfig = Config.all({
  environment: Config.string("ENVIRONMENT").pipe(Config.withDefault("development")),
  ...
  sentryRelease: Config.string("SENTRY_RELEASE").pipe(Config.withDefault("meetsmatch@dev")),
});
