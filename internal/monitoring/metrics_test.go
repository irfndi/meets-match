...
func TestMetricsCollector_GetMetrics(t *testing.T) {
	...
	// Create some metrics
	counter := mc.NewCounter("test_counter", "Test counter", map[string]string{"type": "test"})
	gauge := mc.NewGauge("test_gauge", "Test gauge", map[string]string{"type": "test"})
	histogram := mc.NewHistogram("test_histogram", "Test histogram", map[string]string{"type": "test"})
	summary := mc.NewSummary("test_summary", "Test summary", map[string]string{"type": "test"})
...
func TestMetricsCollector_GetPrometheusMetrics(t *testing.T) {
	...
	// Create some metrics
	counter := mc.NewCounter("http_requests_total", "Total HTTP requests", map[string]string{"method": "GET"})
	gauge := mc.NewGauge("memory_usage_bytes", "Memory usage in bytes", nil)
	...
	prometheusMetrics := mc.GetPrometheusMetrics()
